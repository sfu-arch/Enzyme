...
invoke.cont55:                                    ; preds = %38, %for.body
  ...
  %40 = load i32, i32* %arrayidx.i7.i, align 8, !tbaa !28
...
; Function Attrs: nounwind uwtable mustprogress
define dso_local double @preprocess__Z11matvec_realPdS_(double* nocapture readonly %mat, double* nocapture readonly %vec) #4 {
entry:
  %call = tail call noalias dereferenceable_or_null(16000) i8* @malloc(i64 16000) #26
  %0 = bitcast i8* %call to double*
  br label %for.body
...
; Function Attrs: nounwind uwtable mustprogress
define internal void @diffe_Z11matvec_realPdS_(double* nocapture readonly %mat, double* nocapture %"mat'", double* nocapture readonly %vec, double %differeturn) #4 {
entry:
  %call = tail call noalias nonnull dereferenceable(16000) dereferenceable_or_null(16000) i8* @malloc(i64 16000) #26
  %"call'mi" = tail call noalias nonnull dereferenceable(16000) dereferenceable_or_null(16000) i8* @malloc(i64 16000) #26
...
for.body20:                                       ; preds = %for.cond.cleanup3, %for.body20
  ...
  br i1 %exitcond.not, label %invertfor.body20, label %for.body20, !llvm.loop !14
...
invertfor.body4:                                  ; preds = %incinvertfor.body4, %invertfor.cond.cleanup3
  ...
  %arrayidx8_unwrap = getelementptr inbounds double, double* %vec, i64 %"iv1'ac.0"
  %_unwrap = load double, double* %arrayidx8_unwrap, align 8, !tbaa !8, !invariant.group !219
  %m1diffe = fmul fast double %8, %_unwrap
  %_unwrap7 = mul nuw nsw i64 %"iv'ac.0", 2000
  %_unwrap8 = add nuw nsw i64 %"iv1'ac.0", %_unwrap7
  %"arrayidx6'ipg_unwrap" = getelementptr inbounds double, double* %"mat'", i64 %_unwrap8
  %9 = load double, double* %"arrayidx6'ipg_unwrap", align 8
  %10 = fadd fast double %9, %m1diffe
...
invertfor.body20:                                 ; preds = %for.body20, %incinvertfor.body20
  ...
  %m0diffe = fmul fast double %_unwrap9, %differeturn
  %13 = fadd fast double %m0diffe, %m0diffe
  %"arrayidx22'ipg_unwrap" = getelementptr inbounds double, double* %"'ipc", i64 %"iv3'ac.0"
  %14 = load double, double* %"arrayidx22'ipg_unwrap", align 8
