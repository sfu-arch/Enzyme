...
for benchmark in BENCHMARKS:
    for mode in MODES:
        for unroll in UNROLL:
            ...
            update_dict(reg_constrained_dict, benchmark, mode, unroll, graph.get_actual_avg_lifetime())
            print("------------- ------------- ----------")

write_to_csv(reg_constrained_dict, 'reg_constrained.csv')
